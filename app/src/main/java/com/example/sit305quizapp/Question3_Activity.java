...
public class Question3_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag == 0) {
                    ...
                    Intent intent = new Intent(Question3_Activity.this, Question4_Activity.class);
                    intent.putExtra("username",UserName);
                    intent.putExtra("score",score);
                    startActivity(intent);
                    Question3_Activity.this.finish();
                    flag = 0;
                }
        ...
        btn_one.setText(question.getchoice1(2));
        btn_two.setText(question.getchoice2(2));
        btn_three.setText(question.getchoice3(2));

        answer = question.getCorrectAnswer(2);


        String UserName=getIntent().getStringExtra("username");
        TextView3.setText("Welcome "+UserName+"!");
        TextView4.setText("Android question 3:");
        TextView5.setText(question.getQuestion(2));
