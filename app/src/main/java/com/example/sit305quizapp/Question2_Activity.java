...
public class Question2_Activity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView4.setText("Android question 2:");
        TextView5.setText(question.getQuestion(1));
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag == 0) {
                    ...
                    Intent intent = new Intent(Question2_Activity.this, Question3_Activity.class);
                     intent.putExtra("username",UserName);
                    intent.putExtra("score",score);
                    startActivity(intent);
                    Question2_Activity.this.finish();
                    flag = 0;
                }
        ...
        btn_one.setText(question.getchoice1(1));
        btn_two.setText(question.getchoice2(1));
        btn_three.setText(question.getchoice3(1));
