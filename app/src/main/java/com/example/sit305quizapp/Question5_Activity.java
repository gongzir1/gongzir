...
public class Question5_Activity extends AppCompatActivity {
   ...
   String UserName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (flag == 0) {
                    ...
                    Intent intent = new Intent(Question5_Activity.this, Finish_Activity.class);
                    intent.putExtra("username",UserName);
                    intent.putExtra("score",score);
                    startActivity(intent);
                    Question5_Activity.this.finish();
                    flag = 0;
                }
        ...
        btn_one.setText(question.getchoice1(4));
        btn_two.setText(question.getchoice2(4));
        btn_three.setText(question.getchoice3(4));

        answer = question.getCorrectAnswer(4);


        TextView3.setText("Welcome "+UserName+"!");
        TextView4.setText("Android question 5:");
        TextView5.setText(question.getQuestion(4));
